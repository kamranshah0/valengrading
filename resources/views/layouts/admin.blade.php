    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <aside id="admin-sidebar" 
            ...
            <nav class="flex-1 px-4 space-y-1 overflow-y-auto pb-4 pt-4">
                ...
                <a href="{{ route('admin.site-content') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 {{ request()->routeIs('admin.site-content') ? 'bg-gradient-to-r from-[#A3050A] to-red-700 text-white shadow-lg shadow-red-900/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
