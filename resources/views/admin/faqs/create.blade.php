                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-col gap-2">
                                <label class="flex items-center gap-3 p-3 rounded-lg border border-white/5 bg-[#1C1E21] hover:bg-[#2A2C30] cursor-pointer transition-all">
                                    <input type="checkbox" name="show_on_home" value="1" {{ old('show_on_home') ? 'checked' : '' }} class="w-4 h-4 text-red-500 bg-gray-700 border-gray-600 rounded focus:ring-red-500 focus:ring-2">
                                ...
                                <label class="flex items-center gap-3 p-3 rounded-lg border border-white/5 bg-[#1C1E21] hover:bg-[#2A2C30] cursor-pointer transition-all">
                                    <input type="checkbox" name="show_on_faq" value="1" {{ old('show_on_faq', true) ? 'checked' : '' }} class="w-4 h-4 text-red-500 bg-gray-700 border-gray-600 rounded focus:ring-red-500 focus:ring-2">
                                    <div class="flex flex-col">
